...
| 03 | [scenario-03-stray-detection-safety-net.md](./scenario-03-stray-detection-safety-net.md) | Prove stray detection is avoided in the happy path and recoverable in a fault-injected case | 1 | Implemented |
...
| 12 | [scenario-12-repeatability.md](./scenario-12-repeatability.md) | Prove rerunning from the same snapshot yields the same result | 1 | Implemented |
...
- Scenario implementations may live in dedicated Git worktrees. If a worktree does not contain the generated snapshot fixture locally, set `SNAPSHOTS_ROOT` to the shared snapshot directory before `automation/recovery/prepare`.
...
- [Scenario 03 Report Card](./report-cards/scenario-03-report-card.md)
...
- [Scenario 12 Report Card](./report-cards/scenario-12-report-card.md)
